...
barplot( xtabs(~ Regtyp + factor(SHUS)  , data = dat) , las = 1 , xlab = "PCI Senter" , ylab = "Antall" , col = pal , space = 0.2 , border = FALSE)
...
print(
    xtable(
        ...
        digits = 0 , caption = "Antall prosdyrer etter type og PCI senter") ,
    booktabs = TRUE ,
    rotate.colnames = TRUE)
@
\end{tiny}
...
barplot( xtabs(~ PrimaerBeslutning + factor(SHUS)  , data = dat) , las = 1 , xlab = "PCI Senter" , ylab = "Antall" , col = pal , space = 0.2 , border = FALSE)
...
print(
    xtable(
        ...
        digits = 0 , caption = "Antall prosedyrer etter primær beslutning og PCI senter") ,
    booktabs = TRUE ,
    rotate.colnames = TRUE)
@
\end{tiny}
...
barplot( xtabs(~ PrimaerBeslutning2 + factor(SHUS)  , data = dat) , las = 1 , xlab = "PCI Senter" , ylab = "Antall" , col = pal , space = 0.2 , border = FALSE)
...
barplot( xtabs(~ Vakttid + factor(SHUS)  , data = dat) , las = 1 , xlab = "PCI Senter" , ylab = "Antall" , col = pal , space = 0.2 , border = FALSE)
...
barplot( xtabs(~ Indikasjon + factor(SHUS)  , data = dat) , las = 1 , xlab = "PCI Senter" , ylab = "Antall" , col = pal , space = 0.2 , border = FALSE)
...
print(
    xtable(
        ...
        digits = 0 , caption = "Antall prosedyrer etter indikasjon og PCI senter") ,
    booktabs = TRUE ,
    rotate.colnames = TRUE)
@
\end{tiny}
...
barplot( xtabs(~ Funn + factor(SHUS)  , data = dat) , las = 1 , xlab = "PCI Senter" , ylab = "Antall" , col = pal , space = 0.2 , border = FALSE)
...
print(
    xtable(
        ...
        digits = 0 , caption = "Antall prosedyrer etter funn og PCI senter") ,
    booktabs = TRUE ,
    rotate.colnames = TRUE)
@
\end{tiny}
